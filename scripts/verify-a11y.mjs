...
const CASES = [
  ...
  /* INTERACTIVE charts (focusable, arrow-navigable): the name lives on the
     focusable group and the <svg> is aria-hidden. Both would announce twice. */
  ["LineChart (interactive group)", "LineChart", { points: [12, 18, 15, 24], labels: ["W1", "W2", "W3", "W4"] },
    [/role="group"/, /aria-label="Line chart, 4 points, from 12 to 24"/, /tabindex="0"/i, /aria-live="polite"/, /aria-hidden="true"/],
    [/role="img"/]],
  ["AreaChart (interactive group)", "AreaChart", { series: [{ name: "Paid", points: [3, 6, 9] }], labels: ["Jan", "Feb", "Mar"] },
    [/role="group"/, /tabindex="0"/i, /aria-live="polite"/], [/role="img"/]],
  ["StackedBarChart (interactive group)", "StackedBarChart", { data: [{ label: "Q1", a: 3, b: 4 }], keys: ["a", "b"] },
    [/role="group"/, /tabindex="0"/i, /aria-live="polite"/], [/role="img"/]],
  ["WaterfallChart (interactive group)", "WaterfallChart", { items: [{ label: "Start", value: 100 }, { label: "Search", value: -20 }] },
    [/role="group"/, /tabindex="0"/i, /aria-live="polite"/], [/role="img"/]],
  ...
  ["DonutChart (interactive group)", "DonutChart", { segments: [{ label: "Search", value: 60 }, { label: "Social", value: 40 }] },
    [/role="group"/, /aria-label="Donut chart: Search 60%, Social 40%"/, /tabindex="0"/i, /aria-live="polite"/, /aria-hidden="true"/],
    [/role="img"/]],
  ["ScatterChart (interactive group)", "ScatterChart", { points: [{ x: 1, y: 2 }], xLabel: "Spend", yLabel: "ROAS" },
    [/role="group"/, /aria-label="Scatter chart, 1 points, Spend against ROAS"/, /tabindex="0"/i, /aria-live="polite"/],
    [/role="img"/]],
