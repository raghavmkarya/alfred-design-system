    ...
    >
      ...
      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 10, marginTop: 2 }}>
        ...
        <Button size="sm" variant="ghost" onClick={onDecline} style={ghostFix} iconLeft={
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d={GLYPH.close} /></svg>
        }>{declineLabel}</Button>
      </div>
    </section>
  );
