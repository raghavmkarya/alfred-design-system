  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--density-field-gap)", width: "100%", ...style }}>
      ...
      <div style={{
        ...
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--text-placeholder)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ position: "absolute", insetInlineEnd: 14, pointerEvents: "none" }}><path d={GLYPH.chevronDown} /></svg>
      </div>
