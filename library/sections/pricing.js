/* GENERATED by scripts/build-kits.mjs from library/sections/pricing.jsx — do not edit. */
(function () {
/* ============================================================
...
const libParsePrice = price => {
  ...
  return m ? {
    ...
    currency: "",
    amount: String(price == null ? "" : price)
  };
};
...
const LibPlanCard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, plan.badge)) : null, /*#__PURE__*/React.createElement("h3", {
    style: {
      margin: 0,
      fontFamily: "var(--font-display)",
  ...
  }, plan.name), plan.description ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-sans)",
  ...
  }, plan.description) : null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "baseline",
      gap: 8,
    ...
    style: {
      fontSize: numeric ? "var(--text-display-md)" : "var(--text-h2)"
    }
  }, amount)), plan.period ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "var(--font-sans)",
      fontSize: "var(--text-sm)",
      color: "var(--text-muted)"
    }
  }, plan.period) : null), /*#__PURE__*/React.createElement("ul", {
    style: {
      listStyle: "none",
      margin: 0,
      padding: 0,
  ...
  }, libCheckGlyph), /*#__PURE__*/React.createElement("span", null, f)))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBlockStart: 24
    }
    ...
    fullWidth: true,
    style: highlighted ? undefined : libGhostCta
  }, plan.ctaLabel)));
};
...
function LibPricingTiers2({
  ...
  plans = [{
    ...
    features: ["3 users", "150 AI chat queries a month", "Daily brief, campaign health, and key actions", "Spend mix analysis with up to 5 simulations a month", "Anomaly detection", "Standard platform integrations", "Email support, 3-day SLA"],
    ...
    features: ["8 users", "500 AI chat queries a month", "Full chat access with write-back", "Full spend mix simulation", "CMO overview and campaign health KPIs", "Custom integration requests, 2-week SLA", "Priority support plus onboarding"],
    ...
    features: ["25 users", "800 AI chat queries a month", "Scheduled reports", "Custom metric tracking", "Audit logs and role-based access", "Enterprise integrations plus custom, 1-week SLA", "Dedicated support and implementation assistance"],
    ctaLabel: "Go Max"
  }],
  ...
  const accented = headlineAccent && headline.includes(headlineAccent) ? /*#__PURE__*/React.createElement(React.Fragment, null, headline.slice(0, headline.indexOf(headlineAccent)), /*#__PURE__*/React.createElement(LibGradientText, null, headlineAccent), headline.slice(headline.indexOf(headlineAccent) + headlineAccent.length)) : headline;
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      ...
      alignItems: "stretch",
      marginBlockStart: 56,
      maxWidth: single ? 460 : undefined,
      marginInline: single ? "auto" : undefined
    }
  }, plans.map((p, i) => /*#__PURE__*/React.createElement(LibPlanCard, {
    key: i,
    plan: p,
    highlighted: !!p.badge || single
  }))), enterpriseNote ? /*#__PURE__*/React.createElement("div", {
    style: {
      marginBlockStart: 28,
      display: "flex",
      alignItems: "center",
  ...
  }, enterpriseNote), /*#__PURE__*/React.createElement(Button, {
    variant: "outline",
    size: "sm",
    style: libGhostCta
  }, enterpriseCta)) : null, footnote ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFinePrint,
      textAlign: "center",
      marginBlockStart: 24
...
const libBandGlyph = name => {
  const shapes = {
    support: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
      d: "M4.5 13.5v-2a7.5 7.5 0 0115 0v2"
    ...
    rollout: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
      cx: "12",
      cy: "12",
      r: "8.5"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M8.3 12.4l2.6 2.6 4.8-5.3"
    })),
    volume: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
      d: "M4.5 15.5a7.5 7.5 0 0115 0"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M12 15.5l3.6-3.6"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M4.5 19h15"
    })),
    discount: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    ...
    shield: /*#__PURE__*/React.createElement("path", {
      d: "M12 3.5l7 2.8v5.2c0 4.2-2.9 7.2-7 8.9-4.1-1.7-7-4.7-7-8.9V6.3l7-2.8z"
    })
  };
...
function LibEnterpriseBand2({
  ...
  items = [{
    ...
    detail: "A named team, with answers inside one business day."
  }, {
    icon: "rollout",
    title: "Implementation assistance",
    detail: "I am live on your stack in under three weeks, with your team trained."
  }, {
    icon: "volume",
    title: "Custom AI volume",
    detail: "Query capacity sized to your organisation, not a preset tier."
  }, {
    icon: "discount",
    title: "Volume discounts",
    detail: "Per-seat pricing steps down as seats and modules grow."
  }],
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, sub), chips && chips.length ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 8,
    ...
    size: "lg",
    style: libGhostCta
  }, secondaryCta) : null), finePrint ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFinePrint,
      marginBlockStart: 14
    }
  }, finePrint) : null), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, libBandGlyph(it.icon)), /*#__PURE__*/React.createElement("div", {
    style: {
      minWidth: 0
    }
  }, /*#__PURE__*/React.createElement("div", {
