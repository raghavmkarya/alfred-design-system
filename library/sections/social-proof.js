/* GENERATED by scripts/build-kits.mjs from library/sections/social-proof.jsx — do not edit. */
(function () {
/* ============================================================
...
const LibQuoteCard = ({
  ...
  style: {
    ...
    flex: 1,
    fontFamily: "var(--font-sans)",
    fontSize: big ? 19 : "var(--text-base)",
    lineHeight: "var(--lh-relaxed)",
    color: "var(--text-primary)"
  }
}, "“" + quote + "”"), /*#__PURE__*/React.createElement("figcaption", null, /*#__PURE__*/React.createElement(LibAttribution, {
  name: name,
  title: title,
  company: company
})));
...
const libStarGlyph = /*#__PURE__*/React.createElement("svg", {
  width: "14",
  height: "14",
  viewBox: "0 0 24 24",
  fill: "currentColor",
  ...
  d: "M12 2.8l2.85 5.9 6.45.88-4.72 4.5 1.17 6.4L12 17.4l-5.75 3.08 1.17-6.4-4.72-4.5 6.45-.88L12 2.8z"
}));
const libPlayGlyph = (size = 22) => /*#__PURE__*/React.createElement("svg", {
  width: size,
  height: size,
  viewBox: "0 0 24 24",
  fill: "currentColor",
...
const libChevronGlyph = open => /*#__PURE__*/React.createElement("svg", {
  width: "16",
  height: "16",
  viewBox: "0 0 24 24",
  fill: "none",
...
const libTrustGlyph = kind => {
  ...
  if (kind === "cert") return /*#__PURE__*/React.createElement("svg", svgProps, /*#__PURE__*/React.createElement("circle", {
    cx: "12",
    cy: "9",
    r: "5.2"
  }), /*#__PURE__*/React.createElement("path", {
  ...
  if (kind === "globe") return /*#__PURE__*/React.createElement("svg", svgProps, /*#__PURE__*/React.createElement("circle", {
    cx: "12",
    cy: "12",
    r: "9"
  }), /*#__PURE__*/React.createElement("path", {
  ...
  if (kind === "lock") return /*#__PURE__*/React.createElement("svg", svgProps, /*#__PURE__*/React.createElement("rect", {
    x: "5",
    y: "11",
    width: "14",
    height: "9",
  ...
  if (kind === "data") return /*#__PURE__*/React.createElement("svg", svgProps, /*#__PURE__*/React.createElement("ellipse", {
    cx: "12",
    cy: "5.5",
    rx: "7",
    ry: "2.5"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M5 5.5V18.5c0 1.4 3.1 2.5 7 2.5s7-1.1 7-2.5V5.5"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M5 12c0 1.4 3.1 2.5 7 2.5s7-1.1 7-2.5"
  }));
  /* shield-check, the default */
  return /*#__PURE__*/React.createElement("svg", svgProps, /*#__PURE__*/React.createElement("path", {
    d: "M12 3l7 2.8v5.4c0 4.4-2.9 7.4-7 9-4.1-1.6-7-4.6-7-9V5.8L12 3z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M9 11.8l2.1 2.1 4-4.4"
  }));
};
...
function LibLogoCloud({
  ...
  const marks = (hidden, pad) => /*#__PURE__*/React.createElement("div", {
    "aria-hidden": hidden || undefined,
    style: {
      display: "flex",
      alignItems: "baseline",
      flexWrap: pad ? "nowrap" : "wrap",
      justifyContent: pad ? "flex-start" : "center",
      columnGap: pad ? 0 : 56,
      rowGap: 22
    }
  ...
  if (variant === "split-quote") {
    ...
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(LibProofHead, {
      eyebrow: eyebrow,
      headline: headline,
      size: 30,
      maxW: 480
    ...
    }, disclaimer) : null), /*#__PURE__*/React.createElement(LibQuoteCard, {
      quote: quote,
      name: quoteName,
      title: quoteTitle,
  ...
  }, /*#__PURE__*/React.createElement(LibProofHead, {
    eyebrow: eyebrow,
    headline: headline,
    center: true,
    size: 26,
    maxW: 640
  }), variant === "marquee" ? /*#__PURE__*/React.createElement("div", {
    style: {
      overflow: "hidden",
      marginBlockStart: 44
    }
  }, /*#__PURE__*/React.createElement("style", null, "@keyframes lib-logo-marquee { from { transform: translateX(0); } to { transform: translateX(-50%); } }"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      width: "max-content",
      animation: "lib-logo-marquee 32s linear infinite"
    }
  }, marks(false, true), marks(true, true))) : /*#__PURE__*/React.createElement("div", {
    style: {
      marginBlockStart: 44
    }
  }, marks(false, false)), disclaimer ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFine,
      marginBlockStart: 36
    }
...
function LibStatBand({
  ...
  items = [{
    ...
    value: "85%",
    label: "of marketing questions answered without an analyst"
  }],
  ...
  const stats = /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...libNumeral(52),
      color: onPanel ? "var(--text-on-brand)" : "var(--text-display)"
    }
    ...
    style: {
      ...
      fontSize: "var(--text-sm)",
      lineHeight: "var(--lh-normal)",
      color: onPanel ? "var(--text-on-brand)" : "var(--text-secondary)",
      opacity: onPanel ? 0.85 : 1,
      marginBlockStart: 10,
      maxWidth: 230
    }
  }, s.label))));
  ...
  }, stats) : stats), footnote ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFine,
      marginBlockStart: 28
    }
...
function LibTestimonials({
  ...
  items = [{
    quote: "I used to spend Sunday nights stitching five reports together. Now I read one brief on Monday morning and walk into the exec meeting already decided.",
    name: "Maya Trent",
    title: "Head of Marketing",
    company: "Meridian"
  }, {
    quote: "Alfred flagged creative fatigue nine days before our agency did. That one catch paid for the year.",
    name: "Daniel Osei",
    title: "VP Marketing",
    company: "Northwind Group"
  }, {
    quote: "The board stopped asking me to prove marketing works. Every number I present traces back to a decision, and every decision traces back to data.",
    name: "Sofia Herrera",
    title: "CMO",
    company: "Bluepeak"
  }],
  ...
  if (variant === "spotlight-metric") {
    ...
    }, metricLabel)), /*#__PURE__*/React.createElement("figure", {
      style: {
        margin: 0
      }
    }, /*#__PURE__*/React.createElement("blockquote", {
    ...
    }, /*#__PURE__*/React.createElement(LibAttribution, {
      name: t.name,
      title: t.title,
      company: t.company,
      size: 40
  ...
  }, items.map((t, i) => /*#__PURE__*/React.createElement(LibQuoteCard, {
    key: i,
    quote: t.quote,
    name: t.name,
    title: t.title,
...
function LibMetricCaseCards({
  ...
  items = [{
    metric: "+18%",
    metricLabel: "pipeline efficiency in the first quarter",
    title: "Meridian rebalanced spend across three channels",
    body: "I flagged that search was outperforming paid social at the margin. Meridian's marketing lead approved the reallocation from the brief, and pipeline efficiency rose 18% in a quarter.",
    ctaLabel: "See the playbook"
  }, {
    metric: "9 days",
    metricLabel: "earlier catch on creative fatigue",
    title: "Northwind refreshed creative before the dip",
    body: "Frequency crossed the fatigue threshold on a Tuesday. I flagged it that morning, nine days before the monthly agency review would have caught it.",
    ctaLabel: "See the playbook"
  }, {
    metric: "12%",
    metricLabel: "less wasted spend in two months",
    title: "Bluepeak cut the campaigns that only looked good",
    body: "Two campaigns had strong platform metrics and weak pipeline contribution. I showed the gap, Bluepeak paused them, and wasted spend fell 12%.",
    ctaLabel: "See the playbook"
  }],
  disclaimer = "Illustrative scenarios with fictional companies.",
  variant = "three-up" /* "three-up" | "featured" */
}) {
  const ctaLink = label => /*#__PURE__*/React.createElement("button", {
    type: "button",
    style: {
      display: "inline-flex",
      alignItems: "center",
  ...
  const card = (c, i, big) => /*#__PURE__*/React.createElement("article", {
    key: i,
    style: {
      ...libCard({
        padding: big ? 40 : 28
  ...
  }, c.metricLabel), /*#__PURE__*/React.createElement("h3", {
    style: {
      ...libDisplay(big ? 24 : 18),
      marginBlockStart: big ? 28 : 20
    }
  }, c.title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-sans)",
      fontSize: big ? "var(--text-base)" : "var(--text-sm)",
      color: "var(--text-secondary)",
      lineHeight: "var(--lh-relaxed)",
      margin: 0,
      marginBlockStart: 10,
  ...
  }, card(items[0], 0, true), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 24
    }
  }, items.slice(1).map((c, i) => card(c, i + 1, false)))) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))",
      gap: 24,
  ...
  }, items.map((c, i) => card(c, i, false))), disclaimer ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFine,
      marginBlockStart: 32
    }
...
function LibReviewBadgeStrip({
  ...
  items = [{
    platform: "SoftwareScout",
    rating: "4.8",
    label: "Decision intelligence"
  }, {
    platform: "StackReview",
    rating: "4.7",
    label: "Marketing leaders"
  }, {
    platform: "B2B Radar",
    rating: "4.9",
    label: "Momentum leader, 2026"
  }],
  ...
  }, footnote) : null), items.map((r, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
  ...
  }, libStarGlyph))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "baseline",
      gap: 6,
...
function LibAvatarClusterStrip({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: libVisuallyHidden
  }, avatarsAlt), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: "1 1 300px",
      minWidth: 240
    }
  ...
  }, text), footnote ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFine,
      marginBlockStart: 8
    }
...
function LibCaseStudyAccordions({
  ...
  items = [{
    title: "The CPA spike that never reached the board",
    summary: "Meridian, paid social",
    metric: "Same-day correction",
    body: "CPA rose 34% overnight. I traced it to creative fatigue in one segment, recommended a refresh plus a 15% budget reallocation, and staged the change. Approved at 8:40 AM, corrected the same day, logged in the audit trail. The board never saw the spike, only the save."
  }, {
    title: "The tracking break caught before the report went out",
    summary: "Northwind Group, analytics",
    metric: "2 reports protected",
    body: "A site deploy silently broke the checkout event at 11 PM. I flagged it in the morning brief, named the two reports it would distort, and drafted the fix ticket. The weekly numbers went out clean instead of wrong."
  }, {
    title: "The budget defence that took one afternoon, not one week",
    summary: "Bluepeak, board prep",
    metric: "12% wasted spend recovered",
    body: "Finance asked for a 10% cut. I ranked every campaign by pipeline contribution, showed which spend was decorative, and Bluepeak's CMO walked into the board meeting with a cut plan that protected pipeline and recovered 12% of wasted spend."
  }],
  disclaimer = "Illustrative scenarios with fictional companies.",
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    }, c.summary)), /*#__PURE__*/React.createElement("span", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 14,
    ...
    }, isOpen ? collapseLabel : expandLabel), libChevronGlyph(isOpen))), isOpen ? /*#__PURE__*/React.createElement("div", {
      id: panelId,
      role: "region",
      "aria-label": c.title,
      style: {
        paddingInline: 28,
        paddingBlock: "0px 28px"
      }
    }, /*#__PURE__*/React.createElement("p", {
      style: {
        fontFamily: "var(--font-sans)",
...
function LibTrustComplianceBand({
  ...
  items = [{
    name: "SOC 2 Type II",
    detail: "Audited annually",
    icon: "shield"
  }, {
    name: "ISO 27001",
    detail: "Certified information security",
    icon: "cert"
  }, {
    name: "GDPR",
    detail: "EU data residency available",
    icon: "globe"
  }, {
    name: "SSO and SCIM",
    detail: "Enforced on every seat",
    icon: "lock"
  }, {
    name: "No model training",
    detail: "Your data never trains shared models",
    icon: "data"
  }],
  ...
  }, libTrustGlyph(c.icon)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "var(--font-sans)",
      fontSize: "var(--text-sm)",
      fontWeight: "var(--fw-bold)",
  ...
  }, c.detail))))), footnote ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFine,
      marginBlockStart: 24
    }
...
function LibAnalystCallout({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    tone: "brand"
  }, eyebrow), /*#__PURE__*/React.createElement("blockquote", {
    style: {
      ...libDisplay(36),
      margin: 0,
      marginBlockStart: 26
  ...
  }, firm, " \xB7 ", report, ", ", year), /*#__PURE__*/React.createElement("div", {
    style: {
      borderBlockStart: "1px solid var(--border-subtle)",
      maxWidth: 560,
      marginInline: "auto",
  ...
  }, statValue), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-sans)",
      fontSize: "var(--text-sm)",
      color: "var(--text-secondary)",
    ...
    variant: "primary",
    size: "lg"
  }, ctaLabel))), disclaimer ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFine,
      marginBlockStart: 36
    }
...
function LibVideoTestimonial({
  ...
  }, duration)), disclaimer ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libFine,
      marginBlockStart: 24
    }
  }, disclaimer) : null), /*#__PURE__*/React.createElement("div", {
    role: "img",
  ...
  }, libPlayGlyph(26)), /*#__PURE__*/React.createElement("span", {
    style: {
      position: "absolute",
      insetBlockStart: 16,
      insetInlineEnd: 16,
  ...
  }, name, " \xB7 ", company), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      flex: 1,
      height: 3,
