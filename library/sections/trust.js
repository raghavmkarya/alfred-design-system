/* GENERATED by scripts/build-kits.mjs from library/sections/trust.jsx — do not edit. */
(function () {
/* ============================================================
...
}, (LIB_TRUST_GLYPHS[name] || LIB_TRUST_GLYPHS.shield).map((d, i) => /*#__PURE__*/React.createElement("path", {
  key: i,
  d: d
})));
...
const LIB_TRUST_DOCS = [{
  ...
  detail: "Architecture, encryption and operational controls, in one narrative document.",
  updated: "2026-06-12",
  action: "Download"
}, {
  icon: "doc",
  name: "Data processing addendum",
  detail: "Our standard DPA, with the EU standard contractual clauses included.",
  updated: "2026-05-30",
  action: "Download"
}, {
  icon: "doc",
  name: "Subprocessor list",
  detail: "Every vendor that touches customer data, with its purpose and region.",
  updated: "2026-07-14",
  action: "Download"
}, {
  icon: "lock",
  name: "Pen-test summary",
  detail: "Executive summary of the most recent third-party penetration test.",
  updated: "2026-04-08",
...
function LibTrustHero({
  ...
  }, libGlyph("search", 16, 2)), /*#__PURE__*/React.createElement("input", {
    type: "search",
    placeholder: searchPlaceholder,
    "aria-label": "Search the trust center",
    style: {
      inlineSize: "100%",
  ...
  }, docs.map((d, i) => /*#__PURE__*/React.createElement("article", {
    key: i,
    style: {
      ...libCard,
      padding: 24,
  ...
  }, libGlyph(d.icon || "doc", 18)), /*#__PURE__*/React.createElement("h2", {
    style: {
      ...libDisplay(18),
      marginBlockStart: 16
    }
  ...
  }, d.detail), /*#__PURE__*/React.createElement("div", {
    style: libMonoCaps({
      marginBlockStart: 16
    })
  }, "Updated ", d.updated), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBlockStart: 14
    }
  ...
  }, d.action))))), footnote ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libMonoCaps({}),
      textAlign: "center",
      marginBlockStart: 36,
...
const LIB_SUBPROCESSORS = [{
  ...
  vendor: "Quarrystone Data",
  purpose: "Warehouse compute for briefs",
  region: "US east",
  updated: "2026-05-19"
}, {
  vendor: "Signalpost Desk",
  purpose: "Customer support tooling",
  region: "EU west",
  updated: "2026-04-26"
}, {
  vendor: "Vaultkeep",
  purpose: "Encrypted backups and recovery",
  region: "EU west",
  updated: "2026-03-11"
}];
function LibSubprocessorTable({
  ...
  }, registerStamp)), /*#__PURE__*/React.createElement(Table, {
    columns: columns,
    rows: rows
...
const LIB_FLOW_CONNECTORS = [{
  label: "Read-only",
  note: "encrypted in transit"
}, {
  label: "Write-back",
  note: "only on your approval"
}];
...
function LibDataFlow({
  ...
  }, libGlyph(n.icon || "doc", 17)), /*#__PURE__*/React.createElement("h3", {
    style: {
      ...libDisplay(17),
      marginBlockStart: 14
    }
  ...
  }, (n.chips || []).map((c, ci) => /*#__PURE__*/React.createElement("span", {
    key: ci,
    style: libChip
  }, c)), n.chipsNote ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "var(--font-mono)",
      fontSize: 10.5,
      color: "var(--text-muted)"
    }
  }, n.chipsNote) : null)), i < nodes.length - 1 && connectors[i] ? /*#__PURE__*/React.createElement(LibFlowConnector, {
    label: connectors[i].label,
    note: connectors[i].note
...
const LIB_COMMITMENTS = [{
  ...
  body: "Models never learn from your workspace, and your prompts are never retained for training."
}, {
  icon: "isolation",
  title: "Logical isolation",
  body: "Every workspace runs in its own isolated context, with encryption keys that belong to it alone."
}, {
  icon: "key",
  title: "SSO and SCIM",
  body: "SAML single sign-on and SCIM provisioning ship on every enterprise plan, with no add-on pricing."
}, {
  icon: "audit",
  title: "Full audit trail",
  body: "Every question, answer and approval is logged, exportable, and reviewable by your admins."
}, {
  icon: "clock",
  title: "Retention controls",
  body: "You set how long anything is kept. Delete a workspace and it is gone within 30 days, backups included."
}, {
  icon: "pin",
  title: "Region pinning",
  body: "Choose EU or US at setup and your data is processed and stored in that region only."
}];
function LibCommitmentsGrid({
  ...
  }, libGlyph(it.icon || "shield", 17)), /*#__PURE__*/React.createElement("div", {
    style: {
      minWidth: 0
    }
  ...
  }, it.body))))), footnote ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libMonoCaps({}),
      textAlign: "center",
      marginBlockStart: 40,
