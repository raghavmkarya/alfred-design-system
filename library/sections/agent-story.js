/* GENERATED by scripts/build-kits.mjs from library/sections/agent-story.jsx — do not edit. */
(function () {
/* ============================================================
...
function LibEmployeeHero({
  ...
  }, libAccent(title, titleAccent)) : /*#__PURE__*/React.createElement("h1", {
    style: {
      ...libDisplay(60),
      maxWidth: 840,
      marginInline: "auto",
  ...
  }, cadenceTail)), sub ? /*#__PURE__*/React.createElement("p", {
    style: {
      ...libSub,
      maxWidth: 600,
      marginInline: "auto",
  ...
  }, libPlayGlyph, secondaryCta)), finePrint ? /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-sans)",
...
function LibStillBrief() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    points: [3.9, 4.1, 4.0, 4.3, 4.4, 4.6],
    height: 36,
    ariaLabel: "Blended ROAS trend, six weeks rising",
    style: {
      width: "100%"
    }
  })));
...
function LibStillMove() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: libMonoCaps({})
  }, "Drafted move"), /*#__PURE__*/React.createElement(Badge, {
    tone: "brand",
    dot: true
  }, "Awaiting sign-off")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "$6K to the winning creative pair"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-sans)",
      fontSize: "var(--text-sm)",
      color: "var(--text-secondary)",
  ...
  }, "Search CPCs rose for a third straight week while PMax held 22% under target cost-per-lead. Reasoning attached."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      marginBlockStart: 14
...
function LibStillWatch() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: libMonoCaps({})
  }, "Change watch"), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({})
  }, "Overnight")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16,
      display: "flex",
      flexDirection: "column",
  ...
  }, ["Ardent moved its demo CTA above the fold", "Lanternworks started bidding on your brand terms", "A new G2 category page listed you fourth"].map((t, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: "flex",
      gap: 10,
...
function LibStillDraft() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: libMonoCaps({})
  }, "Wednesday send"), /*#__PURE__*/React.createElement(Badge, {
    tone: "success",
    dot: true
  }, "On voice")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16
    }
  ...
  }, "\"One number moved this week that deserves your attention. Here is why it did.\""), /*#__PURE__*/React.createElement("p", {
    style: {
      ...libMono({
        color: "var(--text-muted)"
      }),
  ...
  }, "drafted from 214 shipped pieces")));
}
const LIB_STILLS = {
  brief: LibStillBrief,
  move: LibStillMove,
...
const LIB_HIGHLIGHT_CARDS = [{
  claim: "A ranked brief, every morning.",
  outcome: "What moved, why it moved, and the move I'd make next.",
  panel: "brief",
  lead: true
}, {
  claim: "Reallocations drafted, not suggested.",
  outcome: "Approve in one tap and I ship it, on the record.",
  panel: "move"
}, {
  claim: "Competitor watch through the night.",
  outcome: "What changed while you slept, ranked by what it costs you.",
  panel: "watch"
}, {
  claim: "Content that sounds like you.",
  outcome: "Drafts held against your voice before you ever see them.",
  panel: "draft"
}];
function LibHighlightsGrid({
  ...
  cards = LIB_HIGHLIGHT_CARDS,
  /* Array<{claim, outcome, panel: 'brief'|'move'|'watch'|'draft', lead?}> */
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      display: "grid",
      gridTemplateColumns: leadWide ? "repeat(auto-fit, minmax(min(300px, 100%), 1fr))" : "repeat(auto-fit, minmax(min(420px, 100%), 1fr))",
      gap: 20,
      marginBlockStart: 44
    }
  }, cards.map((c, i) => {
    ...
    }, c.claim), /*#__PURE__*/React.createElement("p", {
      style: {
        fontFamily: "var(--font-sans)",
        fontSize: "var(--text-base)",
        color: "var(--text-secondary)",
    ...
    }, c.outcome)), /*#__PURE__*/React.createElement(Still, null));
  }))));
}
...
function LibVoiceLearned({
  ...
  samples = LIB_VOICE_SAMPLES,
  /* Array<{tag, verdict, onVoice, text, note}> */
  footLine = "voice model rebuilt weekly from your shipped work",
  mediaSide = "end" /* "end" | "start" */
}) {
  const pane = /*#__PURE__*/React.createElement("div", {
    style: libPane({})
  }, /*#__PURE__*/React.createElement("div", {
    style: libPaneHeader
  }, /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({})
  }, paneLabel), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({})
  }, paneMeta)), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 18,
      display: "flex",
      flexDirection: "column",
  ...
  }, samples.map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
    ...
    style: libMonoCaps({
      color: s.onVoice ? "var(--text-on-tint-brand)" : "var(--text-muted)"
    })
  }, s.tag, " \xB7 ", s.verdict), /*#__PURE__*/React.createElement("span", {
    style: libMono({
      fontSize: 11,
      color: "var(--text-muted)"
    })
    ...
    style: {
      ...
      fontSize: "var(--text-base)",
      lineHeight: "var(--lh-relaxed)",
      color: s.onVoice ? "var(--text-primary)" : "var(--text-muted)",
      margin: 0,
      marginBlockStart: 10
    }
  ...
  const copy = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(EyebrowBadge, {
    tone: "brand"
  }, eyebrow), /*#__PURE__*/React.createElement("h2", {
    style: {
      ...libDisplay(44),
  ...
  }, mediaSide === "start" ? /*#__PURE__*/React.createElement(React.Fragment, null, pane, copy) : /*#__PURE__*/React.createElement(React.Fragment, null, copy, pane)));
}
...
const LIB_NIGHT_SHIFT = [{
  time: "01:12",
  text: "Synced all 12 sources. Zero gaps."
}, {
  time: "02:47",
  text: "Reran pacing on 14 live campaigns."
}, {
  time: "04:05",
  text: "Caught search CPCs rising for a third week."
}, {
  time: "05:38",
  text: "Drafted the reallocation, reasoning attached."
}, {
  time: "07:30",
  text: "Your brief is ready. Three decisions, ranked.",
  payoff: true
}];
function LibAlwaysOnBand({
  ...
  entries = LIB_NIGHT_SHIFT,
  /* Array<{time, text, payoff?}> */
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, /*#__PURE__*/React.createElement(LibIntro, {
    eyebrow: eyebrow,
    title: title,
    sub: sub
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }, rows.map((e, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    style: {
      display: "flex",
      gap: 16,
    ...
    style: libMono({
      color: e.payoff ? "var(--text-on-tint-brand)" : "var(--text-muted)",
      flexShrink: 0,
      lineHeight: "22px"
    })
...
const LIB_DIFF_ROWS = [{
  sign: "+",
  text: "Northwind cut its starter price by 12%",
  meta: "pricing page"
}, {
  sign: "+",
  text: "Bluepeak shipped a comparison page against you",
  meta: "new url"
}, {
  sign: "-",
  text: "Coreline paused its LinkedIn retargeting",
  meta: "auction data"
}, {
  sign: "+",
  text: "Two of your money keywords got a new bidder",
  meta: "search terms"
}];
function LibOvernightWatch({
  ...
  }), showResponse && responseRow ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      alignItems: "baseline",
...
const LIB_WEEK = [{
  day: "Mon",
  tasks: [{
    title: "Weekly brief to your inbox",
    channel: "Brief",
    tone: "neutral"
  }, {
    title: "Budget pacing reset",
    channel: "Paid",
    tone: "neutral"
  }]
}, {
  day: "Tue",
  tasks: [{
    title: "Search query cleanup",
    channel: "Paid",
    tone: "neutral"
  }, {
    title: "Case-study draft to review",
    channel: "Content",
    tone: "info"
  }]
}, {
  day: "Wed",
  tasks: [{
    title: "Newsletter send, on voice",
    channel: "Email",
    tone: "info"
  }, {
    title: "Landing page test reads out",
    channel: "Web",
    tone: "success"
  }]
}, {
...
function LibWeekInMotion({
  ...
  week = LIB_WEEK,
  /* Array<{day, tasks: {title, channel, tone, approval?}[]}> */
  today = "wed",
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: libMonoCaps({
        color: isToday ? "var(--text-on-tint-brand)" : "var(--text-muted)"
      })
    }, d.day), isToday ? /*#__PURE__*/React.createElement("span", {
      style: libMonoCaps({
        color: "var(--text-on-tint-brand)"
      })
    }, "today") : null), d.tasks.map((t, j) => /*#__PURE__*/React.createElement("div", {
      key: j,
      style: {
      ...
      tone: t.tone || "neutral"
    }, t.channel), t.approval ? /*#__PURE__*/React.createElement("span", {
      style: libMonoCaps({
        color: "var(--text-on-tint-brand)"
      })
    }, approvalLabel) : null))));
...
const LIB_AGENCY_STEPS = [{
  ...
  step: "Wait for the deck",
  cost: "2 wks"
}, {
  step: "Feedback, round two",
  cost: "1 wk"
}, {
  step: "The invoice arrives",
  cost: "$8,500/mo"
}];
const LIB_ALFRED_STEPS = [{
  step: "Ask the question",
  cost: "10 sec"
}, {
  step: "Answer, sources attached",
  cost: "40 sec"
}, {
  step: "You approve",
  cost: "one tap"
}, {
  step: "Shipped and logged",
  cost: "same morning"
}];
function LibAgencyCompare({
  ...
  const beforeCard = /*#__PURE__*/React.createElement("div", {
    ...
    style: libMonoCaps({})
  }, beforeLabel), /*#__PURE__*/React.createElement("ol", {
    style: {
      listStyle: "none",
      margin: 0,
      padding: 0,
  ...
  }, beforeSteps.map((s, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    style: {
      display: "flex",
      justifyContent: "space-between",
  ...
  const afterCard = /*#__PURE__*/React.createElement("div", {
    style: {
      minWidth: 0,
      background: "var(--surface-card)",
  ...
  }, afterLabel), /*#__PURE__*/React.createElement("ol", {
    style: {
      listStyle: "none",
      margin: 0,
      padding: 0,
  ...
  }, afterSteps.map((s, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    style: {
      display: "flex",
      justifyContent: "space-between",
  ...
  }, alfredFirst ? /*#__PURE__*/React.createElement(React.Fragment, null, afterCard, beforeCard) : /*#__PURE__*/React.createElement(React.Fragment, null, beforeCard, afterCard)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10,
      justifyContent: "center",
...
const LIB_LIVE_COUNTERS = [{
  ...
  sublabel: "reporting hours returned"
}];
function LibNumbersLive({
  ...
  counters = LIB_LIVE_COUNTERS,
  /* Array<{value, prefix?, suffix?, label, sublabel?}> */
  ...
  }, counters.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      minWidth: 0,
      textAlign: "center",
  ...
  }, c.label), c.sublabel ? /*#__PURE__*/React.createElement("div", {
    style: libMono({
      fontSize: 11,
      color: "var(--text-muted)",
      marginBlockStart: 5
    })
  }, c.sublabel) : null))), showProgression ? /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 560,
      marginInline: "auto",
      marginBlockStart: 52
  ...
  }, progressionLabel), /*#__PURE__*/React.createElement("span", {
    style: libMono({
      fontSize: 11,
      color: "var(--text-muted)"
    })
  }, startLabel, " ", startPct, "% to ", endLabel, " ", endPct, "%")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      height: 6,
      marginBlockStart: 14,
  ...
  }, progressionLabel, ": from ", startPct, " percent at ", startLabel, " to ", endPct, " percent at ", endLabel, ".")) : null, /*#__PURE__*/React.createElement("p", {
    style: {
      ...libMonoCaps({}),
      textAlign: "center",
      marginBlockStart: 44,
...
window.LibIntro = LibIntro;
window.LibEmployeeHero = LibEmployeeHero;
window.LibStillBrief = LibStillBrief;
window.LibStillMove = LibStillMove;
window.LibStillWatch = LibStillWatch;
window.LibStillDraft = LibStillDraft;
window.LibHighlightsGrid = LibHighlightsGrid;
window.LibVoiceLearned = LibVoiceLearned;
window.LibAlwaysOnBand = LibAlwaysOnBand;
window.LibOvernightWatch = LibOvernightWatch;
