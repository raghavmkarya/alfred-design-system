/* GENERATED by scripts/build-kits.mjs from library/sections/fusion-poster.jsx — do not edit. */
(function () {
/* ============================================================
...
function LibQuotePoster({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      ...
      lineHeight: 1.06,
      maxWidth: compact ? 720 : undefined
    }
    ...
    style: {
      ...
      alignItems: "center",
      gap: 14,
      marginBlockStart: compact ? 28 : 40
    }
  }, /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      width: 36,
      borderBlockStart: "2px solid var(--accent)",
      flexShrink: 0
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({
...
const LIB_STAMPS = [{
  text: "Briefed by 07:00",
  tone: "ink"
}, {
  text: "Receipts not promises",
  tone: "orange"
}, {
  text: "Every channel watched",
  tone: "periwinkle"
}, {
  text: "Nothing ships unapproved",
  tone: "ink"
}];
const LibStamp = ({
  text,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    "aria-label": text,
    style: {
      color: LIB_STAMP_TONES[tone] || LIB_STAMP_TONES.ink
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "lib-fpost-stamp-rotor",
    style: {
      width: 150,
      height: 150,
  ...
  }, ring)), /*#__PURE__*/React.createElement("path", {
    d: "M75 64 L86 75 L75 86 L64 75 Z",
    fill: "currentColor"
  }))));
};
function LibStampBadges({
  ...
  stamps = LIB_STAMPS,
  /* Array<{text, tone: 'ink' | 'periwinkle' | 'orange'}> · one orange max */
  ...
  }, /*#__PURE__*/React.createElement("style", null, libStampCss), /*#__PURE__*/React.createElement("div", {
    style: libContainer({
  ...
  }, stamps.map((s, i) => /*#__PURE__*/React.createElement(LibStamp, {
    key: i,
    text: s.text,
    tone: s.tone,
    pathId: `${idPrefix}-${i}`,
...
}, String(value).split("").map((ch, i) => /*#__PURE__*/React.createElement("span", {
  key: i,
  style: {
    position: "relative",
    display: "inline-flex",
...
function LibSplitFlap({
  ...
  stats = LIB_FLAP_STATS,
  /* Array<{value, label, live?}> · one live value max */
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: libMonoCaps({})
  }, updatedLabel)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, /*#__PURE__*/React.createElement(LibFlapValue, {
    value: s.value,
    live: s.live
  }), /*#__PURE__*/React.createElement("div", {
    style: {
...
function LibGradientPanelPoster({
  ...
  const inkCta = /*#__PURE__*/React.createElement("span", {
    className: "lib-fpost-cta"
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, /*#__PURE__*/React.createElement("style", null, libSpringCss), /*#__PURE__*/React.createElement(LibGrain, {
    opacity: 0.05
  }), /*#__PURE__*/React.createElement("div", {
    style: libContainer({
      position: "relative",
      paddingBlock: justified ? "96px 80px" : "104px 96px",
    ...
    style: {
      ...libPoster("clamp(48px, 7.5vw, 112px)"),
      lineHeight: 1.0,
      color: ink,
      maxWidth: justified ? undefined : 900,
      marginInline: justified ? undefined : "auto",
      marginBlockStart: 22
    }
  }, claim), justified ?
  /*#__PURE__*/
  ...
  }, sub), inkCta) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
      ...libSub,
      color: ink,
      opacity: 0.8,
...
const LIB_COUNTERS = [{
  ...
  sublabel: "in Meridian's first pass"
}, {
  value: 70,
  suffix: "%",
  label: "Faster decisions",
  sublabel: "question to approved move"
}, {
  value: 15,
  suffix: " hrs",
...
function LibCounterBand({
  ...
  }, /*#__PURE__*/React.createElement("style", null, libSpringCss), /*#__PURE__*/React.createElement("div", {
    style: libContainer({
      paddingBlock: "80px 72px"
    })
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, c.sublabel) : null))), /*#__PURE__*/React.createElement("p", {
    style: {
      ...libMonoCaps({}),
      marginBlockStart: 40,
      marginBlockEnd: 0
...
function LibKineticStack({
  lines = LIB_KINETIC_LINES,
  /* Array<{text, style: 'solid' | 'outline' | 'gradient', tilt, indent, z}> */
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    const base = {
      ...libPoster("clamp(52px, 8vw, 120px)"),
      lineHeight: 0.96,
      display: "block",
      width: "max-content",
      maxWidth: "100%",
    ...
    if (l.style === "gradient") {
      return /*#__PURE__*/React.createElement("span", {
        key: i,
        style: base
      }, /*#__PURE__*/React.createElement(LibGradientText, null, l.text));
    }
    if (l.style === "gradient-word" && l.word && l.text.includes(l.word)) {
      ...
      return /*#__PURE__*/React.createElement("span", {
        key: i,
        style: base
      }, l.text.slice(0, at), /*#__PURE__*/React.createElement(LibGradientText, null, l.word), l.text.slice(at + l.word.length));
    }
    return /*#__PURE__*/React.createElement("span", {
      key: i,
      style: base
