/* GENERATED by scripts/build-kits.mjs from library/sections/partners.jsx — do not edit. */
(function () {
/* ============================================================
...
function LibPartnerHero({
  ...
  stats = [{
    value: "20%",
    label: "Margin share",
    note: "on every client seat you manage"
  }, {
    value: "40+",
    label: "Client seats",
    note: "run from one partner console"
  }, {
    value: "2 wks",
    label: "To certification",
    note: "for your first operator cohort"
  }]
}) {
...
const LIB_PARTNER_TIERS = [{
  ...
  benefits: ["Partner console with your first three client seats", "Self-serve certification track for two operators", "Co-branded one-pager for your pitches", "Standard support, one business day"],
  ctaLabel: "Start here",
  ...
  benefits: ["20% margin share on every managed seat", "Priority onboarding for each new client", "Quarterly roadmap briefing with our team", "Listing in the partner directory", "Co-sell support on deals over $25K"],
  ctaLabel: "Apply now",
  requirement: "req :: 5 live clients · 4 certified operators"
}, {
  name: "Strategic",
  summary: "For groups running Alfred across the whole book.",
  benefits: ["Named partner manager and a shared channel", "Joint go-to-market budget each quarter", "Early access to new Alfred modules", "Custom margin terms at portfolio scale"],
  ctaLabel: "Talk to us",
...
function LibPartnerTiers({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, t.name), t.badge ? /*#__PURE__*/React.createElement(Badge, {
      tone: "brand"
    }, t.badge) : null), /*#__PURE__*/React.createElement("p", {
      style: {
        fontFamily: "var(--font-sans)",
        fontSize: "var(--text-sm)",
        color: "var(--text-secondary)",
    ...
    }, t.summary), /*#__PURE__*/React.createElement("ul", {
      style: {
        listStyle: "none",
        margin: 0,
        padding: 0,
    ...
    }, t.benefits.map((b, j) => /*#__PURE__*/React.createElement("li", {
      key: j,
      style: {
        display: "flex",
        gap: 10,
    ...
    }, libCheckGlyph), /*#__PURE__*/React.createElement("span", null, b)))), /*#__PURE__*/React.createElement("div", {
      style: {
        marginBlockStart: 24
      }
    }, /*#__PURE__*/React.createElement(Button, {
      ...
      size: "md",
      fullWidth: true,
      style: hot ? undefined : libGhostCta
    }, t.ctaLabel)), /*#__PURE__*/React.createElement("div", {
      style: {
        ...libMonoCaps({}),
        marginBlockStart: 16,
        paddingBlockStart: 14,
        borderBlockStart: "1px dashed var(--border-subtle)"
      }
    }, t.requirement));
  }))));
}
...
function LibAgencyProof({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    key: i,
    style: {
      ...(markFace[m.style] || markFace.sans),
      whiteSpace: "nowrap"
    }
  ...
  }, marksLabel), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, quoteRole)))), /*#__PURE__*/React.createElement("div", {
    style: {
      minWidth: 0,
      background: "var(--surface-card)",
  ...
  }, consoleLabel), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({})
  }, consoleMeta)), /*#__PURE__*/React.createElement("div", null, clients.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: "grid",
  ...
  }, c.pace), /*#__PURE__*/React.createElement(Badge, {
    tone: c.tone,
    dot: true
