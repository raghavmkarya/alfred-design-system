/* GENERATED by scripts/build-kits.mjs from library/sections/fusion-terminal.jsx — do not edit. */
(function () {
/* ============================================================
...
const LIB_LOG_LINES = [{
  time: "07:58:41",
  level: "ok",
  text: "sync complete :: 12 sources, 0 gaps"
}, {
  time: "08:00:12",
  level: "info",
  text: "checked spend pacing across 14 campaigns"
}, {
  time: "08:01:27",
  level: "warn",
  text: "search CPC up 9% for the third straight week"
}, {
  time: "08:01:59",
  level: "info",
  text: "traced the drift to two brand campaigns"
}, {
  time: "08:02:14",
  level: "flag",
  text: "reallocation drafted :: $18K to Performance Max"
}, {
  time: "08:02:15",
  level: "info",
  text: "queued for approval, nothing ships without you"
}];
...
function LibLogStream({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, /*#__PURE__*/React.createElement("style", null, libStreamCss), /*#__PURE__*/React.createElement("div", {
    style: libContainer({
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      className: newest ? "lib-ft-stream-new" : undefined,
      style: {
        display: "flex",
        alignItems: "baseline",
        gap: 12,
  ...
  }), /*#__PURE__*/React.createElement("span", null, paused ? pausedLine : followingLine)), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({})
  }, retentionLine)))));
}
...
const LIB_API_TABS = [{
  ...
  lines: [{
    prompt: true,
    text: "curl https://api.seekalfred.ai/v1/ask \\"
  }, {
    prompt: true,
    text: '  -H "Authorization: Bearer alfred_live_51x…" \\'
  }, {
    prompt: true,
    text: '  -d \'{ "question": "Where should budget move this week?" }\''
  }]
}, {
  id: "typescript",
  label: "TypeScript",
...
const LIB_API_RESPONSE = ['{', '  "decision": "shift $18K to Performance Max",', '  "confidence": 0.86,', '  "evidence": ["google_ads", "ga4", "crm"]', '}'];
const LIB_API_STEPS = [{
  num: "01",
  title: "Create a key",
  body: "One key per workspace, scoped read-only until you widen it."
}, {
  num: "02",
  title: "Ask a real question",
  body: "Plain language in. I pull from every connected source before answering."
}, {
  num: "03",
  title: "Read the evidence",
  body: "Each answer returns its confidence and the sources it stands on."
}];
function LibApiQuickstart({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    type: "button",
    "aria-label": "Copy the request",
    onClick: () => {
      if (typeof navigator !== "undefined" && navigator.clipboard) navigator.clipboard.writeText(tab.lines.map(l => l.text).join("\n"));
    },
    style: {
      ...libMonoCaps({
        color: "var(--text-secondary)"
  ...
  }, endpoint), tab.lines.map((l, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...libMonoLine,
      fontSize: 12.5,
  ...
  }, l.text)))), showResponse ? /*#__PURE__*/React.createElement("div", {
    dir: "ltr",
    style: {
      borderBlockStart: "1px solid var(--border-subtle)",
  ...
  }, responseLabel), responseLines.map((l, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...libMonoLine,
      fontSize: 12.5,
...
const LIB_SHORTCUT_GROUPS = [{
  ...
  items: [{
    ...
    label: "Rerun this morning's brief",
    keys: ["B"]
  }, {
  ...
  group: "Act",
  items: [{
    label: "Approve the queued reallocation",
    keys: ["A"],
    highlight: true
  }, {
...
function LibShortcutGrid({
  ...
  }, it.keys.map((k, j) => /*#__PURE__*/React.createElement(Kbd, {
    key: j
...
const LIB_BOOT_LINES = [{
  text: "handshake :: Google Ads connected",
  time: "0.8s"
}, {
  text: "handshake :: GA4 connected",
  time: "1.2s"
}, {
  text: "handshake :: CRM connected",
  time: "0.9s"
}, {
  text: "backfill :: 24 months of spend history",
  time: "2m 41s"
}, {
  text: "model :: learning how Meridian decides",
  time: "1m 22s"
}];
...
function LibBootSequence({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, /*#__PURE__*/React.createElement("style", null, libBootCss), /*#__PURE__*/React.createElement("div", {
    style: libContainer({
      paddingBlock: "88px 88px",
      maxWidth: 860
    })
    ...
    key: i,
    className: animate ? "lib-ft-boot-line" : undefined,
    style: {
      display: "flex",
      alignItems: "baseline",
      gap: 12,
      animationDelay: animate ? i * 0.45 + "s" : undefined
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
    ...
    style: {
      ...
      gap: 12,
      marginBlockStart: 4,
      animationDelay: animate ? lines.length * 0.45 + "s" : undefined
    }
  }, /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
  ...
  }, readyLine), /*#__PURE__*/React.createElement("span", {
    className: animate ? "lib-ft-boot-cursor" : undefined,
    "aria-hidden": "true",
    style: {
...
const LIB_MAN_QUESTIONS = [{
  q: "Does Alfred ship changes on its own?",
  a: "No. I draft the move and attach the reasoning; nothing reaches a platform until you approve it. Auto-approval thresholds exist, and you set them."
}, {
  q: "How long does setup take?",
  a: "One afternoon. You grant the connections, I backfill the history and learn how your organisation decides. The first brief lands the next morning at 07:00."
}, {
  q: "Where does my data live?",
  a: "In your stack. I read through the connections you grant, keep an audit line for every read, and never move your data into places you have not named."
}, {
  q: "What if I disagree with a call?",
  a: "Tell me. Every recommendation carries its evidence trail, so you can challenge the reasoning line by line, and I learn your thresholds from the verdict."
}];
function LibManPageFaq({
  ...
  const manHeader = label => /*#__PURE__*/React.createElement("div", {
    style: {
      ...libMonoCaps({
        color: "var(--text-secondary)"
      }),
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: libMonoCaps({})
  }, headerStart), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({
      color: "var(--text-secondary)"
    })
  }, headerMid), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({})
  ...
  }, manHeader(nameLabel), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-sans)",
      fontSize: "var(--text-base)",
      color: "var(--text-primary)",
  ...
  }, nameBody), /*#__PURE__*/React.createElement("div", {
    "aria-hidden": "true",
    style: {
      borderBlockEnd: "1px solid var(--border-subtle)",
      marginBlock: 24
    }
  }), manHeader(synopsisLabel), /*#__PURE__*/React.createElement("p", {
    dir: "ltr",
    style: {
      ...libMonoLine,
      fontSize: 12.5,
  ...
  }, synopsisLine), /*#__PURE__*/React.createElement("div", {
    "aria-hidden": "true",
    style: {
      borderBlockEnd: "1px solid var(--border-subtle)",
      marginBlock: 24
    }
  }), manHeader(questionsLabel), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column"
    }
  }, questions.map((it, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
...
const LIB_REPLAY_TRANSCRIPT = [{
  ...
  verb: "compared",
  text: "against the last six Mondays",
  tone: "info"
}, {
  verb: "flagged",
...
function LibReplayPane({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, /*#__PURE__*/React.createElement(ConsolePanel, {
    connected: connected,
  ...
  }), markers.map((m, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    title: m.label,
    style: {
      position: "absolute",
      insetInlineStart: "calc(" + m.at + "% - 3px)",
      insetBlockStart: 8,
      width: 6,
      height: 6,
      borderRadius: "var(--radius-circle)",
    ...
    style: {
      position: "absolute",
      insetInlineStart: "calc(" + playheadAt + "% - 6px)",
      insetBlockStart: 5,
      width: 12,
      height: 12,
      borderRadius: "var(--radius-circle)",
  ...
  }, startStamp), /*#__PURE__*/React.createElement("span", {
    style: libMonoCaps({
      fontSize: 10
    })
  }, midStamp), /*#__PURE__*/React.createElement("span", {
    style: {
      ...libMonoLine,
      fontSize: 11,
      color: "var(--text-muted)"
