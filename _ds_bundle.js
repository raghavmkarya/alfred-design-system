...
__ds_scope.GLYPH = GLYPH;
})(); } catch (e) { (__ds_ns.__errors).push({ source: "components/hooks/glyphs.jsx", error: String((e && e.message) || e) }); }

// components/hooks/hitArea.jsx
try { (() => {
/**
...
__ds_scope.HitArea = HitArea;
__ds_scope.HIT_RELATIVE = HIT_RELATIVE;
})(); } catch (e) { (__ds_ns.__errors).push({ source: "components/hooks/hitArea.jsx", error: String((e && e.message) || e) }); }

// components/hooks/usePress.jsx
try { (() => {
/**
...
function usePress({
  ...
  if (hover || press) bind.onMouseLeave = () => {
...
function ChartTable({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: HIDDEN
  }, /*#__PURE__*/React.createElement("table", null, /*#__PURE__*/React.createElement("caption", null, caption), /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, columns.map((c, i) => /*#__PURE__*/React.createElement("th", {
    key: i,
    scope: "col"
 ...
 * Internal: components/hooks/ is kept off the public namespace by the bundle.
 */
function useChartCursor(count, options = {}) {
...
const boxFrac = (box, x, y) => box ? {
  fx: (box.ox + x * box.s) / box.w,
  fy: (box.oy + y * box.s) / box.h
} : null;

/** container offset → viewBox point, for hit-testing against plot geometry. */
const boxPoint = (box, px, py) => box && box.s ? {
  x: (px - box.ox) / box.s,
  y: (py - box.oy) / box.s
} : null;
...
function ChartTooltip({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      /* rtl-ok: chart coordinate space — the readout flips on available room, not on reading direction */
      pointerEvents: "none",
...
__ds_scope.useSvgBox = useSvgBox;
__ds_scope.ChartLive = ChartLive;
__ds_scope.ChartTooltip = ChartTooltip;
__ds_scope.CHART_FOCUS_STYLE = CHART_FOCUS_STYLE;
__ds_scope.boxFrac = boxFrac;
__ds_scope.boxPoint = boxPoint;
...
function Logo({
  ...
  const fileFor = t => variant === "mark" ? t === "white" ? "alfred-icon-white.svg" : "alfred-icon.svg" : variant === "wordmark" ? t === "white" ? "alfred-wordmark-white.svg" : "alfred-wordmark.svg" : t === "white" ? "alfred-logo-white.svg" : "alfred-logo-primary.svg";
  if (tone === "auto") {
    ...
    return /*#__PURE__*/React.createElement("span", _extends({
      ...
      className: "ds-logo-color",
      src: `${root}/${fileFor("color")}`,
      alt: "Alfred ai",
      loading: "lazy",
      style: {
        height,
      ...
      className: "ds-logo-white",
      src: `${root}/${fileFor("white")}`,
      alt: "Alfred ai",
      loading: "lazy",
      style: {
        height,
...
// components/brand/BrandMoment.jsx
try { (() => {
const { Logo } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
@keyframes ${id}-rise {
  ...
  }, rest), /*#__PURE__*/React.createElement("style", null, css), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      position: "absolute",
      insetInlineStart: "50%",
      ...
      pointerEvents: "none",
      background: ["radial-gradient(closest-side, rgba(167,167,252,0.40), rgba(167,167,252,0) 72%) 42% 38% / 78% 78% no-repeat", "radial-gradient(closest-side, rgba(255,132,49,0.34), rgba(255,132,49,0) 72%) 60% 62% / 78% 78% no-repeat"].join(", "),
...
__ds_scope.BrandMoment = BrandMoment;
})(); } catch (e) { (__ds_ns.__errors).push({ source: "components/brand/BrandMoment.jsx", error: String((e && e.message) || e) }); }
...
const SCENES = {
  ...
  empty: g => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grad, {
    id: g
    ...
    d: "M52 78 h136 a6 6 0 0 1 6 6 v40 a10 10 0 0 1 -10 10 H56 a10 10 0 0 1 -10 -10 v-40 a6 6 0 0 1 6 -6 Z",
    fill: SOFT,
    stroke: "var(--border-default)",
    strokeWidth: "3"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M46 100 h44 l9 14 h42 l9 -14 h44",
    fill: "none",
    stroke: "var(--border-default)",
    strokeWidth: "3",
    strokeLinejoin: "round"
  ...
  "no-results": g => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grad, {
    id: g
  }), [0, 1, 2].map(r => [0, 1, 2, 3, 4].map(c => /*#__PURE__*/React.createElement("circle", {
    key: `${r}-${c}`,
    cx: 48 + c * 32,
    cy: 46 + r * 30,
    r: "5",
    ...
    d: "M96 62 l24 24 M120 62 l-24 24",
    stroke: "var(--border-default)",
    strokeWidth: "3",
    strokeLinecap: "round",
    fill: "none"
  ...
  error: g => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grad, {
    id: g
  }), /*#__PURE__*/React.createElement("rect", {
    x: "46",
    y: "34",
  ...
  success: g => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grad, {
    id: g
  }), /*#__PURE__*/React.createElement("circle", {
    cx: "120",
    cy: "82",
  ...
  connecting: g => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grad, {
    id: g
  }), /*#__PURE__*/React.createElement("rect", {
    x: "28",
    y: "56",
  ...
  "first-run": g => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Grad, {
    id: g
  }), /*#__PURE__*/React.createElement("path", _extends({
    d: "M40 134 h160"
  }, LINE)), /*#__PURE__*/React.createElement("rect", {
    x: "62",
    y: "98",
    width: "30",
    height: "36",
    ...
    d: "M198 30 l4 9 l9 4 l-9 4 l-4 9 l-4 -9 l-9 -4 l9 -4 Z",
    fill: "var(--accent)"
  }))
};
...
function Illustration({
  ...
  }, rest), /*#__PURE__*/React.createElement("title", null, label), scene(`ill-${uid}`));
}
__ds_scope.Illustration = Illustration;
})(); } catch (e) { (__ds_ns.__errors).push({ source: "components/brand/Illustration.jsx", error: String((e && e.message) || e) }); }
...
function Card({
  ...
  const [canHover] = React.useState(() => typeof window === "undefined" || !window.matchMedia ? true : window.matchMedia("(hover: hover)").matches);
  const tones = {
    surface: {
...
try { (() => {
const { GLYPH, HitArea, HIT_RELATIVE } = __ds_scope;
/**
 * Alfred AI — Chip
...
function Chip({
  ...
  }, /*#__PURE__*/React.createElement(HitArea, null), /*#__PURE__*/React.createElement("svg", {
    width: "14",
    height: "14",
    viewBox: "0 0 24 24",
    fill: "none",
...
function Badge({
  ...
  const tones = {
    neutral: {
      ...
      dotc: "var(--text-placeholder)"
    },
    brand: {
      bg: "var(--accent-soft)",
      fg: "var(--text-on-tint-brand)",
      dotc: "var(--accent)"
    },
    info: {
      bg: "var(--info-100)",
      fg: "var(--text-on-tint-info)",
      dotc: "var(--info-500)"
    },
    success: {
      bg: "var(--success-100)",
      fg: "var(--text-on-tint-success)",
...
const Input = React.forwardRef(function Input(props, ref) {
  ...
  const borderColor = error ? "var(--danger-500)" : focus ? "var(--border-focus)" : fill === "plain" ? "var(--border-default)" : "transparent";
  return /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
    ...
    style: {
      ...
      borderRadius: "var(--radius-md)",
      padding: "0 var(--density-field-pad-x)",
 ...
 */
const AUTO_TONES = [{
  bg: "var(--periwinkle-100)",
  fg: "var(--text-on-tint-info)"
}, /* raw-ramp-ok: fixed auto-avatar tint palette (re-maps in app-dark; light monogram disc on marketing dark is intentional) */
{
  bg: "var(--success-100)",
  fg: "var(--text-on-tint-success)"
}, {
  bg: "var(--orange-100)",
  fg: "var(--text-on-tint-brand)"
}, /* raw-ramp-ok: fixed auto-avatar tint palette */
{
  bg: "var(--gray-100)",
  fg: "var(--text-secondary)"
} /* raw-ramp-ok: fixed auto-avatar tint palette */];
function Avatar({
  ...
  const fixed = {
    ...
    ink: "var(--ink-900)",
    periwinkle: "var(--periwinkle-400)"
  }[tone]; /* raw-ramp-ok: fixed brand-identity avatar tones (solid ink / periwinkle discs) */
...
function Button({
  ...
  const sizes = {
    sm: {
      height: "var(--density-control-h-sm)",
      padding: "0 var(--density-control-pad-sm)",
      font: "var(--text-sm)",
      radius: "var(--radius-md)",
      gap: 8
    },
    md: {
      height: "var(--density-control-h-md)",
      padding: "0 var(--density-control-pad-md)",
      font: "var(--text-base)",
      radius: "var(--radius-md)",
      gap: 10
    },
    lg: {
      height: "var(--density-control-h-lg)",
      padding: "0 var(--density-control-pad-lg)",
      font: "var(--text-lg)",
  ...
  const variants = {
    ...
    /* raw-ramp-ok: ink-on-periwinkle brand secondary — no semantic equivalent (fixed light fill) */
    outline: {
      background: "transparent",
      color: "var(--text-primary)",
  ...
  const hoverStyle = !disabled && hover ? {
    ...
    /* raw-ramp-ok: brand secondary hover (fixed periwinkle) */
    outline: {
...
const Select = React.forwardRef(function Select(props, ref) {
  ...
  const border = error ? "var(--danger-500)" : focus ? "var(--border-focus)" : fill === "plain" ? "var(--border-default)" : "transparent";
  return /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
    ...
    style: {
      ...
      height: "100%",
      paddingBlock: "0",
      paddingInline: "var(--density-field-pad-x) 40px",
      fontFamily: "var(--font-sans)",
      fontSize: "var(--text-base)",
...
const Combobox = React.forwardRef(function Combobox({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: "var(--density-field-h)",
      paddingBlock: "0",
      paddingInline: "var(--density-field-pad-x) 14px",
...
const Textarea = React.forwardRef(function Textarea(props, ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      border: `1.5px solid ${borderColor}`,
      borderRadius: "var(--radius-md)",
      padding: "var(--density-field-pad-y) var(--density-field-pad-x)",
      boxShadow: focus ? "var(--shadow-focus)" : "none",
      transition: "border-color var(--dur-base) var(--ease-standard), box-shadow var(--dur-base) var(--ease-standard)",
      opacity: disabled ? "var(--opacity-disabled)" : 1
    }
...
try { (() => {
const { Icon, usePress } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function IconButton({
  ...
  title,
  label,
  // accessible name for the icon-only button (falls back to title)
  onClick,
  disabled = false,
  style = {}
}) {
...
try { (() => {
const { Spinner, GLYPH } = __ds_scope;
/**
...
function FileDropzone({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      border: `2px dashed ${active ? "var(--border-focus)" : "var(--border-default)"}`,
...
try { (() => {
const { isFocusVisible } = __ds_scope;
/**
...
function KpiCard({
  ...
  // e.g. "+12.4%"
  direction = "up",
  // "up" | "down" | "flat" — arrow glyph
  valence,
  // "good" | "bad" | "neutral" — chip color; defaults from direction
  caption,
  // e.g. "vs last 30 days"
  icon,
  // brand icon name (optional, quiet)
  iconRoot = "assets/icons",
  style = {}
}) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
      ...
      style: {
        ...
        color: done ? "var(--text-on-orange)" : active ? "var(--text-on-tint-brand)" : "var(--text-placeholder)",
        fontFamily: "var(--font-sans)",
        fontSize: "var(--text-sm)",
        fontWeight: "var(--fw-bold)"
      }
...
try { (() => {
const { GLYPH, Button, Spinner } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function ProgressBar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height,
      borderRadius: "var(--radius-pill)",
      background: showTrack ? "var(--border-default)" : "transparent",
      overflow: "hidden",
      ...style
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  return /*#__PURE__*/React.createElement("ol", {
    ...
    return /*#__PURE__*/React.createElement("li", {
      ...
      style: {
        ...
        width: 2,
        marginLeft: -1,
        /* rtl-ok: half-width nudge that centres on `left: 50%`; both must stay physical */background: "var(--border-default)"
      }
    }), /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true",
      style: {
...
try { (() => {
const { ChartTable, useChartCursor, ChartLive, ChartTooltip, CHART_FOCUS_STYLE } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Alfred AI — AreaChart
...
function AreaChart({
  ...
  return (
    ...
    React.createElement("div", _extends({}, cursor.bind, {
      style: {
        width: "100%",
        position: "relative",
        ...CHART_FOCUS_STYLE,
...
try { (() => {
const { ChartTable, useChartCursor, ChartLive, CHART_FOCUS_STYLE } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function DonutChart({
  ...
  const mid = size / 2;
  // WCAG 1.1.1 — a bare <svg> exposes nothing to a screen reader.
  const aria = ariaLabel || (segments.length ? `Donut chart: ${segments.map(s => `${s.label} ${Math.round(s.value / total * 100)}%`).join(", ")}` : "Donut chart, no data");
  ...
  const cursor = useChartCursor(segments.length, {
    hitTest
  });
  const at = cursor.index;
  ...
  return (
    ...
    React.createElement("div", _extends({}, cursor.bind, {
      ...
      text: cursor.keyboard && at != null ? segLabel(at) : ""
      ...
      return /*#__PURE__*/React.createElement("circle", {
        ...
        strokeDashoffset: -bounds[i][0] * c
      });
    }))), (at != null || centerLabel || centerSub) && /*#__PURE__*/React.createElement("div", {
    ...
    }, at != null ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      style: big
    }, segments[at].value), /*#__PURE__*/React.createElement("span", {
      style: small
    }, segments[at].label, " \xB7 ", share(at), "%")) : /*#__PURE__*/React.createElement(React.Fragment, null, centerLabel && /*#__PURE__*/React.createElement("span", {
      style: big
...
function GaugeChart({
  ...
  const zones = (segments || []).filter(z => z && typeof z.upTo === "number").map(z => ({
    ...
    color: z.color,
    label: z.label
  })).sort((a, b) => a.upTo - b.upTo).map((z, i, all) => ({
    ...z,
    from: i === 0 ? 0 : all[i - 1].upTo,
    name: z.label || `Band ${i + 1}`
  }));
  ...
  const cursor = useChartCursor(zones.length, {
    hitTest
  });
  const at = cursor.index;
  const band = at != null ? zones[at] : null;
  const bandText = band ? `${band.name}: ${fmt(band.from)} to ${fmt(band.upTo)}` : "";
  const bandLive = band ? `${bandText}${value >= band.from && value < band.upTo ? `, holds the current ${fmt(value)}` : ""}` : "";
  return (
    /*#__PURE__*/
    ...
    React.createElement("div", _extends({}, zones.length ? cursor.bind : null, {
      role: zones.length ? "group" : undefined,
      "aria-label": zones.length ? aria : undefined,
      style: {
        position: "relative",
        width: size,
        ...(zones.length ? CHART_FOCUS_STYLE : null),
        ...style
      }
    }), zones.length > 0 && /*#__PURE__*/React.createElement(ChartLive, {
      text: cursor.keyboard && band ? bandLive : ""
    }), /*#__PURE__*/React.createElement(ChartTable, {
      caption: aria,
      ...
      /* the bands read their bounds off `zones`, which is what the arcs are
         ...
         a segment has — every band printed an empty value. */.concat(zones.map(z => [z.name, `${fmt(z.from)} to ${fmt(z.upTo)}`]))
    }), /*#__PURE__*/React.createElement("svg", {
      width: size,
      height: H,
      viewBox: `0 0 ${size} ${H}`,
      ...
      style: {
        ...
        top: 0,
        left: 0,
        /* rtl-ok: chart coordinate space, see guidelines/rtl.md */
        width: size,
        height: size,
        display: "flex",
        flexDirection: "column",
    ...
    }, fmt(value)), (band || sub) && /*#__PURE__*/React.createElement("span", {
      "aria-hidden": band ? "true" : undefined,
      style: {
        fontFamily: "var(--font-sans)",
        fontSize: "var(--text-xs)",
        color: band ? "var(--text-secondary)" : "var(--text-muted)",
        lineHeight: 1.2,
        marginTop: 4,
        textAlign: "center"
      }
...
function BulletChart({
  ...
  const scaleOf = it => {
    ...
    return {
      value,
      target,
      top: it.max || Math.max(value, target || 0, 1)
    };
  };
  ...
  const describe = i => {
    ...
    return `${it.label || `Metric ${i + 1}`}: ${fmt(value)}` + (target != null ? `, target ${fmt(target)}` : "") + (pct != null ? `, ${pct}% of target` : "");
  };
  return (
    /*#__PURE__*/
    ...
    React.createElement("div", _extends({}, cursor.groupBind, {
      ...
      text: cursor.keyboard && at != null ? describe(at) : ""
    }), items.map((it, i) => {
      const {
        value,
        target,
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        x: (targetPct != null ? targetPct : valuePct) / 100,
        y: 0.5,
        visible: on
      }, target != null ? `target ${fmt(target)}${pct != null ? ` · ${pct}%` : ""}` : `${fmt(value)} of ${fmt(top)}`)), /*#__PURE__*/React.createElement("div", {
        style: {
          flex: "none",
          minWidth: 52,
          textAlign: "end",
...
try { (() => {
const { ChartTable, useChartCursor, useSvgBox, boxFrac, ChartLive, ChartTooltip, CHART_FOCUS_STYLE } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function SankeyChart({
  ...
  // WCAG 1.1.1 — a bare <svg> exposes nothing to a screen reader.
  const aria = ariaLabel || (nodes.length ? `Sankey flow diagram, ${nodes.length} nodes and ${links.length} flows` : "Sankey flow diagram, no data");
  ...
  return (
    ...
    React.createElement("div", _extends({}, cursor.groupBind, {
      ...
      text: cursor.keyboard && at != null ? linkLabel(at) : ""
    }), /*#__PURE__*/React.createElement(ChartTable, {
      caption: aria,
      columns: ["From", "To", "Value"],
      rows: links.map(l => [String(l.source), String(l.target), String(fmt(l.value || 0))])
    }), anchor && /*#__PURE__*/React.createElement(ChartTooltip, {
      x: anchor.fx,
      y: anchor.fy,
      visible: true
    }, linkLabel(at)), /*#__PURE__*/React.createElement("svg", {
      ref: svgRef,
      onPointerLeave: cursor.clear,
      viewBox: `0 0 ${W} ${height}`,
      width: "100%",
      ...
      return /*#__PURE__*/React.createElement("path", {
        ...
        onPointerEnter: () => cursor.point(i),
        style: {
          transition: "fill-opacity var(--dur-fast) var(--ease-standard), stroke-opacity var(--dur-fast) var(--ease-standard)"
        }
      });
    }), nodes.map(n => {
      const p = pos[n.id];
...
function ScatterChart({
  ...
  // WCAG 1.1.1 — a bare <svg> exposes nothing to a screen reader.
  const aria = ariaLabel || (points.length ? `Scatter chart, ${points.length} points${xLabel && yLabel ? `, ${xLabel} against ${yLabel}` : ""}` : "Scatter chart, no data");
  const svgRef = React.useRef(null);
  const box = useSvgBox(svgRef, W, height);
  ...
  return (
    ...
    React.createElement("div", _extends({}, cursor.groupBind, {
      ...
      text: cursor.keyboard && at != null ? ptLabel(at) : ""
    }), /*#__PURE__*/React.createElement(ChartTable, {
      caption: aria,
      ...
      y: anchor.fy,
      visible: true
    }, ptLabel(at)), /*#__PURE__*/React.createElement("svg", _extends({
      ref: svgRef
    }, cursor.plotBind, {
      viewBox: `0 0 ${W} ${height}`,
      width: "100%",
      ...
      return /*#__PURE__*/React.createElement("g", {
        ...
        r: r + 7,
        fill: `url(#${uid}h${i})`
      }), i === at && /*#__PURE__*/React.createElement("circle", {
        cx: cx,
        cy: cy,
        r: r + 4,
        fill: "none",
...
function WaterfallChart({
  ...
  const aria = ariaLabel || items.length ? `Waterfall from ${bars[0].label ?? "start"} to ${bars[bars.length - 1].label ?? "end"}` : "Waterfall chart";
  if (bars.length === 0) {
    return /*#__PURE__*/React.createElement("div", {
      style: {
        width: "100%",
  ...
  /* Interactive chart: the NAME lives on the focusable group and the graphic is
     aria-hidden — see the note in LineChart and guidelines/chart-contract.md. */
  return /*#__PURE__*/React.createElement("div", _extends({}, cursor.bind, {
    style: {
      width: "100%",
      position: "relative",
      ...CHART_FOCUS_STYLE,
...
try { (() => {
const { ChartTable, useChartCursor, ChartLive, ChartTooltip, CHART_FOCUS_STYLE, Legend } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function StackedBarChart({
  ...
  const rawMax = grouped ? Math.max(0, ...data.flatMap(d => visible.map(k => num(d && d[k])))) : Math.max(0, ...totals);
  ...
  return (
    ...
    React.createElement("div", _extends({}, cursor.bind, {
      ...
      caption: aria,
      columns: ["Group"].concat(visible.map(String)),
...
function Menu({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onMouseEnter: () => {
      if (!it.disabled) setActiveIndex(i);
    },
    style: {
      display: "flex",
      alignItems: "center",
    ...
    style: {
      display: "inline-flex",
      color: it.danger ? "var(--danger-500)" : "var(--text-muted)"
    }
  }, it.icon), it.label)));
}
...
function Drawer({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      background: "var(--overlay-scrim)",
      opacity: atRest ? 1 : 0,
      transition: `opacity var(${exiting ? "--dur-fast" : "--dur-base"}) var(--ease-standard)`
    }
  }), /*#__PURE__*/React.createElement("div", {
    ref: panelRef,
    tabIndex: -1,
    onTransitionEnd: e => {
      if (exiting && e.target === panelRef.current && e.propertyName === "transform") setExiting(false);
    },
    style: {
      position: "absolute",
      top: 0,
      ...
      /* rtl-ok: `side` is a physical placement API — side="right" means right */
  ...
  }, /*#__PURE__*/React.createElement(HitArea, {
    inset: -2
  }), /*#__PURE__*/React.createElement("svg", {
    width: "20",
    height: "20",
...
function Tooltip({
  ...
  const origin = {
    ...
    bottom: "top center",
    left: "right center",
    // rtl-ok: pairs with the physical placement above
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    onFocus: requestOpen,
    onBlur: requestClose
  }, children, show && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
...
function Banner({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round"
  }, glyphs[tone] || glyphs.info)), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minWidth: 0
    }
...
function Callout({
  ...
  const tones = {
    insight: {
      accent: "var(--text-on-tint-info)",
      bg: "rgba(167,167,252,0.14)",
      actionColor: "var(--text-on-tint-info)"
    },
    success: {
    ...
    warning: {
      accent: "var(--text-on-tint-brand)",
      bg: "rgba(255,132,49,0.14)",
      actionColor: "var(--text-on-tint-brand)"
    },
    danger: {
...
function StepFlow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      top: 19,
      left: "calc(50% + 24px)",
      right: "calc(-50% + 24px)" /* rtl-ok: symmetric connector geometry */,
      height: 2,
      background: "var(--border-default)"
    }
  }), /*#__PURE__*/React.createElement("span", {
...
try { (() => {
const { GLYPH, usePress } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Alfred AI — PriceCard
...
function PriceCard({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      ...
      top: -13,
      left: "50%",
      /* rtl-ok: 50% centring is direction-neutral */
      transform: "translateX(-50%)",
      display: "inline-flex",
      alignItems: "center",
      height: 26,
  ...
  }, check), /*#__PURE__*/React.createElement("span", null, feature)))), cta && /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    onClick: cta.onClick
  }, bind, {
    style: ctaStyle
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        textTransform: "uppercase",
        fontWeight: "var(--fw-bold)",
        color: done ? "var(--text-secondary)" : on ? "var(--accent-hover)" : "var(--text-muted)"
      }
    }, s));
...
function OfferSwitch({
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    ...
    style: {
      ...
      boxShadow: "var(--elevation-raised)",
      pointerEvents: "none",
      transform: checked ? "translateX(calc(16px * var(--flip)))" : "translateX(0)",
      transition: "transform var(--dur-base) var(--ease-emphasized)"
    }
  })));
}
...
// components/marketing/ConsolePanel.jsx
try { (() => {
/**
...
function ConsolePanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, connected.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 9,
  ...
  }, connectedLabel + " :: " + connected.join(" · "))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8
    ...
    style: {
      color: VERB_TONE[l.tone || "neutral"] || VERB_TONE.neutral,
      fontWeight: "var(--fw-semibold)"
    }
  }, l.verb), " " + l.text))), readyLine && /*#__PURE__*/React.createElement("div", {
    style: {
      ...monoLine,
      color: "var(--text-primary)",
      display: "flex",
  ...
  }))), /*#__PURE__*/React.createElement("style", null, `@keyframes dsConsoleBlink{0%,49%{opacity:1}50%,100%{opacity:0.15}}`));
}
__ds_scope.ConsolePanel = ConsolePanel;
})(); } catch (e) { (__ds_ns.__errors).push({ source: "components/marketing/ConsolePanel.jsx", error: String((e && e.message) || e) }); }
...
function DashboardMock({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      display: "grid",
      gridTemplateColumns: `repeat(${kpiData.length}, minmax(0, 1fr)) auto`,
      gap: 10
    }
...
try { (() => {
const { usePress, GLYPH } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
// components/trust/EvidenceLedger.jsx
try { (() => {
/**
...
function EvidenceLedger({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, /*#__PURE__*/React.createElement(LedgerMark, null), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-2xs)",
      fontWeight: "var(--fw-bold)",
      letterSpacing: "var(--ls-caps)",
  ...
  }, "Evidence ledger")), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-xs)",
      color: "var(--text-muted)",
      whiteSpace: "nowrap"
    }
  }, "Updated ", updated)), /*#__PURE__*/React.createElement("h3", {
    style: {
      marginBlock: "15px 13px",
      fontFamily: "var(--font-display)",
      fontSize: "var(--text-h4)",
      fontWeight: "var(--fw-semibold)",
      lineHeight: "var(--lh-snug)",
    ...
    tone: "support"
  }, supporting, " support"), /*#__PURE__*/React.createElement(SummaryChip, {
    tone: contradicting ? "contradict" : "context"
  }, contradicting, " contradict"), /*#__PURE__*/React.createElement(SummaryChip, {
    tone: "context"
  }, evidence.length, " sources"))), /*#__PURE__*/React.createElement("div", {
    role: "list",
    style: {
      display: "flex",
      flexDirection: "column"
    }
  }, evidence.map((item, index) => /*#__PURE__*/React.createElement(EvidenceRow, {
...
function EvidenceRow({
  ...
  }, tone.symbol), /*#__PURE__*/React.createElement("span", {
    style: {
      minWidth: 0,
      display: "flex",
      flex: 1,
  ...
  }, item.finding), item.freshness ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-xs)",
      color: "var(--text-muted)"
    }
  }, item.freshness) : null), onOpen ? /*#__PURE__*/React.createElement(Arrow, null) : null);
  const shared = {
    boxSizing: "border-box",
    width: "100%",
    display: "flex",
...
const DEFAULT_EVIDENCE = [{
  source: "LinkedIn Ads",
  stance: "supports",
  finding: "Qualified pipeline per dollar improved 24% over the last 28 days.",
  freshness: "Live data · 2 min ago"
}, {
  source: "HubSpot",
  stance: "supports",
  finding: "ABM opportunities are progressing 1.4 times faster than paid search.",
  freshness: "Synced · 8 min ago"
}, {
  source: "Finance plan",
  stance: "contradicts",
  finding: "The proposed shift leaves paid search 6% below its monthly floor.",
  freshness: "Plan version 12 · today"
}];
__ds_scope.EvidenceLedger = EvidenceLedger;
})(); } catch (e) { (__ds_ns.__errors).push({ source: "components/trust/EvidenceLedger.jsx", error: String((e && e.message) || e) }); }
...
function ConfidenceMeter({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      /* rtl-ok: the other half of the physical `left` above — see guidelines/rtl.md */
      width: s.notch,
      borderRadius: "var(--radius-pill)",
      background: "var(--surface-card)",
      border: "1px solid var(--border-default)",
...
function InsightFeedback({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: compact ? 14 : 15
  }), compact ? null : "Useful"), /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
  ...
  }, reasons.map((reason, i) => /*#__PURE__*/React.createElement("button", _extends({
    key: reason,
    type: "button",
  ...
  }), reason)), /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    onClick: () => {
      fire("not-useful");
      setStage("done");
...
try { (() => {
const { ConfidenceMeter, SourceTrace, GLYPH } = __ds_scope;
/**
...
try { (() => {
const { GLYPH, Button, Badge, ConfidenceMeter } = __ds_scope;
/**
...
function RecommendationCard({
  ...
  }, "I recommend")), /*#__PURE__*/React.createElement(Badge, {
    tone: p.badge,
    dot: true
...
function SidebarItem({
  ...
  const labelColor = active ? "var(--text-on-tint-brand)" : hover ? "var(--text-primary)" : "var(--text-secondary)";
  const iconColor = active ? "var(--accent)" : hover ? "var(--text-secondary)" : "var(--text-muted)";
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
...
function StatTile({
  ...
  // "up" | "down" | "flat" — arrow glyph
  valence,
  // "good" | "bad" | "neutral" — pill color; defaults from direction
  caption = "",
  points = [],
  color = "var(--accent)",
  // accent override
  ...
  const d = {
    ...dir,
    ...(valence ? tones[valence] || tones.neutral : null)
  };
...
try { (() => {
const { GLYPH, Modal, Button } = __ds_scope;
/**
...
try { (() => {
const { Avatar, Badge, GLYPH } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function ConnectionHealthCard({
  ...
  }, isSyncing && /*#__PURE__*/React.createElement("style", null, `
              @keyframes ${cls}-pulse {
                0%, 100% { opacity: 1; }
                50%      { opacity: 0.3; }
              }
...
try { (() => {
const { Avatar, SourceTrace, GLYPH } = __ds_scope;
/**
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("li", {
      ...
      style: {
        ...
        width: 2,
        marginLeft: -1,
        /* rtl-ok: half-width nudge that centres on `left: 50%`; both must stay physical */
        background: "var(--border-default)"
      }
    }), /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true",
...
try { (() => {
const { GLYPH, Button, Badge, Avatar } = __ds_scope;
/**
...
// components/decision/DecisionFork.jsx
try { (() => {
/**
...
function DecisionFork({
  ...
  }, "Decision fork"), /*#__PURE__*/React.createElement("h3", {
    style: {
      margin: 0,
      fontFamily: "var(--font-display)",
      fontSize: "var(--text-h3)",
  ...
  }, title), context ? /*#__PURE__*/React.createElement("p", {
    style: {
      marginBlock: "7px 0",
      maxWidth: 600,
      fontSize: "var(--text-sm)",
  ...
  }, context) : null), /*#__PURE__*/React.createElement(ForkGlyph, null)), /*#__PURE__*/React.createElement("div", {
    role: "radiogroup",
...
function Option({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Alfred's pick") : /*#__PURE__*/React.createElement("span", {
    style: {
      height: 22,
      marginBlockEnd: 14
    }
  ...
  }, option.eyebrow), /*#__PURE__*/React.createElement("strong", {
    style: {
      display: "block",
      fontFamily: "var(--font-display)",
      fontSize: "var(--text-h4)",
  ...
  }, option.outcome)), option.description ? /*#__PURE__*/React.createElement("p", {
    style: {
      marginBlock: "13px 15px",
      fontSize: "var(--text-sm)",
      lineHeight: "var(--lh-normal)",
      color: "var(--text-secondary)"
    }
  }, option.description) : null, /*#__PURE__*/React.createElement("dl", {
    style: {
      display: "grid",
  ...
  })), option.tradeoffs?.length ? /*#__PURE__*/React.createElement("ul", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8,
      marginBlock: "15px 18px",
      padding: 0,
      listStyle: "none"
    }
  }, option.tradeoffs.map((tradeoff, index) => /*#__PURE__*/React.createElement("li", {
    key: index,
    style: {
      display: "flex",
      alignItems: "flex-start",
    ...
    "aria-hidden": "true",
    style: {
      color: index === 0 ? "var(--success-500)" : "var(--warning-500)",
      fontWeight: "var(--fw-bold)"
    }
  }, index === 0 ? "+" : "−"), tradeoff))) : null, /*#__PURE__*/React.createElement("button", {
    type: "button",
    role: "radio",
    "aria-checked": checked,
    onClick: onChoose,
    style: {
      ...
      minHeight: 40,
      border: checked ? 0 : "1px solid var(--border-strong)",
      borderRadius: "var(--radius-md)",
...
function ForkGlyph() {
  return /*#__PURE__*/React.createElement("span", {
    ...
    d: "M6 3v5c0 2.2 1.8 4 4 4h8"
  }), /*#__PURE__*/React.createElement("path", {
    d: "m15 9 3 3-3 3"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M6 21v-5c0-2.2 1.8-4 4-4"
  })));
}
...
__ds_scope.DecisionFork = DecisionFork;
})(); } catch (e) { (__ds_ns.__errors).push({ source: "components/decision/DecisionFork.jsx", error: String((e && e.message) || e) }); }
...
__ds_ns.BrandMoment = __ds_scope.BrandMoment;
...
__ds_ns.ConsolePanel = __ds_scope.ConsolePanel;
...
__ds_ns.EvidenceLedger = __ds_scope.EvidenceLedger;
